...
public class UserChannelManager {
     ...
     * @throws
     */
    public static void writeAndFlush(@NonNull Long uid, @NonNull Object message, @NonNull MessageActionTypeEnum typeEnum) {
        ...
        for (Channel channel : channelSet) {
            ...
            if (channel.isActive()) {
                ...
                WebSocketMessage webSocketMessage = new WebSocketMessage()
                        .setActionType(typeEnum.ordinal())
                        .setData(JSON.toJSONString(message));
     ...
     * @param typeEnum
     */
    public static void writeAndFlush(@NonNull Object message, @NonNull MessageActionTypeEnum typeEnum) {
        // 构造消息
        WebSocketMessage webSocketMessage = new WebSocketMessage()
                .setActionType(typeEnum.ordinal())
                .setData(JSON.toJSONString(message));
